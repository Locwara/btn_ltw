        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" action="trangchu.php" method="GET" role="search">
            ...
            <div class="chuaspall">
                ...
                ?>
                    <div class="chuasanpham">
                        ...
                        <div class="chuachu">
                            <h4> Tên sản phẩm: <?php echo $sp['name'] ?></h4>
                            <p> Giá: <?php echo $sp['price'] ?></p>
                            <textarea disabled> Mô tả: <?php echo $sp['description'] ?></textarea>
                            <p> Trạng thái: <?= ($sp['status'] == 1) ? 'Hiển thị' : (($sp['status'] == 2) ? 'Ẩn' : 'Đã khóa') ?></p>
                        </div>
                        <div class="chuabtn">
